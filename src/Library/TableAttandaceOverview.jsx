...
function TableAttendaceOverview({ItemList,HeaderArray}) {
         ...
         <TableBody>
          {ItemList.map((item,i) => (
            ...
            >
              ...
              <TableCell align="center">{item.IsActive  && <ClearIcon sx={{color:"red"}}/>}</TableCell>
              <TableCell align="center">{item.IsActive  && <ClearIcon sx={{color:"red"}}/>}</TableCell>
              <TableCell align="center">{item.IsActive  && <ClearIcon sx={{color:"red"}}/>}</TableCell>
              <TableCell align="center">{item.IsActive  && <ClearIcon sx={{color:"red"}}/>}</TableCell>
              <TableCell align="center">{item.IsActive  && <ClearIcon sx={{color:"red"}}/>}</TableCell>
...
export default TableAttendaceOverview